...
@section('konten')
    ...
    <div style="display: block; width: 100%;">
        <div class="card-bodycoy" style=" margin-bottom: 3%; margin-top: 3%; background-color: white;">
            <h4 class="card-title">Data Bimbingan Sosial Reschedule</h4>
        ...
        <form class="forms-sample" action="{{ url('/guru/konseling/addbimbingansosial') }}" method="POST">
            ...
            <div class="card-bodyform">
                ...
                <form class="forms-sample" action="{{ url('/guru/konseling/addbimbingansosial') }}" method="POST">
                    ...
                    <div class='form-group'>
                        <p>Murid</p>
                        <select class="js-example-basic-multiple" id="multiplemurid" multiple="multiple"
                            style="width: 100%;" name="murid_id[]">
                            <option value=""></option>
                        </select>
                    </div>
                    {{-- <div class="form-group">
            ...
            <div class="card-body" id="tableguru" style="background-color: white">
                <h4 class="card-title">Data Bimbingan Sosial Accept</h4>
