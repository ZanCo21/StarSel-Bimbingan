...
@section('konten')
    ...
    <div style="display: block; width: 100%;">
        <div class="card-bodycoy" style=" margin-bottom: 3%; margin-top: 3%; background-color: white;">
            <h4 class="card-title">Data Bimbingan Karir</h4>
            <p class="card-description"> Data<code>.Waiting</code>
            </p>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="/guru/konseling/getbimbingankarir/{{ $item->id }}">
                                            <label class="badge badge-success">Input Jadwal</label>
                                        </a>
    ...
    <div class="card-bodyrawan" id="tableguru" style="background-color: white; margin-top: 3%; margin-bottom: 5%;">
        <h4 class="card-title">BImbingan Karis</h4>
