                        ...
                        <div class="grid md:grid-cols-2 text-sm">
                            ...
                            <div class="grid grid-cols-2">
                                ...
                                @if ($getdetail->status == 'complete')
                                    <div class="px-4 py-2"><span class="badge badge-info">{{ $getdetail->status }}</span>
                                    </div>
                                @endif
                                ...
                                <div class="px-4 py-2"><span class="badge badge-success">{{ $getdetail->status }}</span>
                                </div>
                            @endif
                            @if ($getdetail->status == 'reschedule')
                                <div class="px-4 py-2"><span class="badge badge-warning">{{ $getdetail->status }}</span>
                                </div>
                            @endif
                            </div>
                            <div class="grid grid-cols-2">
                            ...
                            <div class="grid grid-cols-2">
                                ...
                                <div class="px-4 py-2">{{ $getdetail->tempat }}</div>
                            </div>
                        </div>
                    </div>
