...
@section('konten')
    ...
    <div class="card-body">
        ...
        <p class="card-description">Basic form layout</p>
            <form class="forms-sample" action="/walas/hasil-konsultasi/kesimpulan/update/{{ $konsul->id }}" method="POST">
        {{ csrf_field() }}
        <input type="text" class="form-control" name="kesimpulans" placeholder="Kesimpulan"/>
        <br>
        <button class="btn btn-primary mr-2"> Submit </button>
        <a href="/walas/hasil-konsultasi/">
